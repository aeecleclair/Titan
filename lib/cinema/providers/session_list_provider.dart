...
class SessionListNotifier extends ListNotifier2<CineSessionComplete> {
  ...
  Future<bool> addSession(CineSessionComplete session) async {
    return await add(
        (session) async => sessionRepository.cinemaSessionsPost(
  ...
  Future<bool> updateSession(CineSessionComplete session) async {
    return await update(
        (session) async => sessionRepository.cinemaSessionsSessionIdPatch(
  ...
  Future<bool> deleteSession(CineSessionComplete session) async {
    return await delete(
        (sessionId) async => sessionRepository.cinemaSessionsSessionIdDelete(
            sessionId: sessionId),
