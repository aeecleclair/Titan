...
final adminDeliveryOrderListProvider =
    StateNotifierProvider<UserOrderListNotifier, AsyncValue<Map<Delivery, AsyncValue<List<Order>>>>>(
        (ref) {
  ...
  tokenExpireWrapperAuth(ref, () async {
    ...
    for (Delivery delivery in deliveries) {
      final orderList = await orderListRepository.getDeliveryOrderList(delivery.id);
