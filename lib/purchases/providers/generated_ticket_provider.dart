...
class GeneratedTicketNotifier extends StateNotifier<GeneratedTicket> {
  GeneratedTicketNotifier({required String token}) : super(GeneratedTicket.empty());
...
final generatedTicketProvider = StateNotifierProvider<GeneratedTicketNotifier, GeneratedTicket>((ref) {
