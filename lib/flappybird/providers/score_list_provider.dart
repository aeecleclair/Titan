...
class ScoreListNotifier extends ListNotifier2<FlappyBirdScoreInDB> {
  final Openapi scoreRepository;
  ScoreListNotifier({required this.scoreRepository}) : super(const AsyncLoading());
  ...
  Future<bool> createScore(FlappyBirdScoreBase score) async {
    return await add(() => scoreRepository.flappybirdScoresPost(body: score), score);
  }
}

final scoreListProvider =
    StateNotifierProvider<ScoreListNotifier, AsyncValue<List<FlappyBirdScoreInDB>>>((ref) {
