        ...
        child: Refresher(
          ...
          child: Column(children: [
            const Align(
              ...
              child: Text(PhonebookTextConstants.edit,
                  style: TextStyle(
                      fontSize: 20,
            ...
            Form(
                ...
                child: Column(children: [
                  associationKinds.when(
                    ...
                    error: (error, stack) {
                      return const Text(
                          PhonebookTextConstants.errorKindsLoading);
                    },
                    loading: () {
            ...
            ...associationMemberList.when(
              data: (data) {
                return data
                .map((member) => MemberEditableCard(member: member)).toList();
              },
              error: (error, stackTrace) {
                return const [Text(PhonebookTextConstants.errorLoadAssociationMember),];
              },
              loading: () => [
                const Center(
                  child: CircularProgressIndicator(),
