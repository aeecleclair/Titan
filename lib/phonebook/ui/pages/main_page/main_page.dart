...
class MainPage extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref)  {
    ...
    final filteredAssociationList = ref.watch(filteredAssociationListProvider);
    ...
    final associationKindsNotifier = ref.watch(associationKindsProvider.notifier);
            ...
            child: Column(
              children: [
                ...
                associationList.when(
                  data: (associations) {
                    return associations.map((association) => AssociationCard(
