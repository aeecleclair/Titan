...
class LoginColorConstants {
  static const Color gradient1 = Color(0xFF1dbead);
  static const Color gradient2 = Color(0xFF27d790);
  static const Color background = Color(0xFF222643);
}
