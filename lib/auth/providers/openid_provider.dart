...
/// This notifier manages the caching state of the authentication token.
/// It extends StateNotifier with a boolean state indicating whether the token is being cached.
class IsAuthCachedNotifier extends StateNotifier<bool> {
  IsAuthCachedNotifier(super.b);
...
/// This provider checks if the user is caching their authentication token.
/// It reads the cached token from the cache manager and sets the state
final isAuthCachedProvider = StateNotifierProvider<IsAuthCachedNotifier, bool>((
  ref,
) {
  final IsAuthCachedNotifier isAuthCachedNotifier = IsAuthCachedNotifier(false);
