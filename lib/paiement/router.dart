...
import 'package:myemapp/paiement/ui/pages/admin_page/admin_page.dart'
    deferred as admin_page;
import 'package:myemapp/paiement/ui/pages/fund_page/web_view_modal.dart'
    deferred as fund_page;
import 'package:myemapp/paiement/ui/pages/store_pages/add_edit_store.dart'
    deferred as add_edit_page;
import 'package:myemapp/paiement/ui/pages/store_admin_page/store_admin_page.dart'
    deferred as store_admin_page;
import 'package:myemapp/paiement/ui/pages/devices_page/devices_page.dart'
    deferred as devices_page;
import 'package:myemapp/paiement/ui/pages/main_page/main_page.dart'
    deferred as main_page;
import 'package:myemapp/paiement/ui/pages/stats_page/stats_page.dart'
    deferred as stats_page;
import 'package:myemapp/paiement/ui/pages/store_stats_page/store_stats_page.dart'
    deferred as store_stats_page;
import 'package:myemapp/paiement/ui/pages/transfer_structure_page/transfer_structure_page.dart'
