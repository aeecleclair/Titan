...
import 'package:myecl/paiement/ui/pages/admin_store_admin_page/search_result.dart';
...
class AdminStoreAdminPage extends HookConsumerWidget {
  const AdminStoreAdminPage({super.key});
              ...
              builder: (context, storeSellers) {
                return Column(
                  children: [
                    ...storeSellers.map(
                      (storeSeller) {
                        return AdminSellerRightCard(storeSeller: storeSeller);
                      },
                    ),
                  ],
                );
