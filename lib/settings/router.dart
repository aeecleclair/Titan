...
import 'package:myemapp/settings/ui/pages/change_pass/change_pass.dart'
    deferred as change_pass;
import 'package:myemapp/settings/ui/pages/edit_user_page/edit_user_page.dart'
    deferred as edit_user_page;
import 'package:myemapp/settings/ui/pages/log_page/log_page.dart'
    deferred as log_page;
import 'package:myemapp/settings/ui/pages/main_page/main_page.dart'
    deferred as main_page;
import 'package:myemapp/settings/ui/pages/modules_page/modules_page.dart'
    deferred as modules_page;
import 'package:myemapp/settings/ui/pages/notification_page/notification_page.dart'
