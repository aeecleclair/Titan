...
class PlayerInfoEloNotifier extends ListNotifier<Player>{
  ...
  void setId(String Id) {
   ...
   Future<AsyncValue<List<Player>>> loadPlayerInfo({String? given_id}) async {
    return await loadList(() async => _playerDetailRepository.getPlayerInfo(given_id ?? id));
  }
}

final playerInfoProvider = StateNotifierProvider<PlayerInfoEloNotifier, AsyncValue<List<Player>>>((ref) {
