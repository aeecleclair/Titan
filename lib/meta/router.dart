...
import 'package:myecl/meta/ui/pages/main_page/main_page.dart'
...
class MetaRouter {
  final Ref ref;
  static const String root = '/meta';
  static const String admin = '/admin';
  static const String addEditAdvert = '/add_edit_meta';
  ...
  QRoute route() => QRoute(
        name: "meta",
        path: MetaRouter.root,
        builder: () => main_page.MetaMainPage(),
        middleware: [
