                          ...
                          child: Column(
                            children: [
                                ...
                                children: [
                                  Row(
                                    children: [
                                      CircleAvatar(
                                        ...
                                        /*backgroundImage:
                                            meta.announcer.photoUrl.isNotEmpty
                                                ? NetworkImage(
                                                    meta.announcer.photoUrl)
                                                : null,*/
                                        child: const Icon(
                                          Icons.person,
                                          color: Colors.white,
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            "Jutssou"
                                                .trim(), // Nom de l’association
                                            style: TextStyle(
                                              color: Colors.grey.shade600,
                                              fontSize:
                                                  14, // Plus petit que le nom principal
                                            ),
                                          ),
                                        ],
                                      ),
                                  ...
                                  Text(
                                    DateFormat('HH:mm dd/MM/yy').format(
                                        meta.date), // TODO: Fix Date format
                                    style: const TextStyle(
                                      color: Colors.grey,
                                      fontSize: 14,
                                    ),
                              ...
                              TextWithHyperLink(
                                ...
                                maxLines: false
                                    ? 3
                                    : 6, // TODO: If image is present, show only 3 lines
                                minFontSize: 13,
                                maxFontSize: 15,
                                style: const TextStyle(
                                  color: Colors.black,
                              ...
                              if (meta.date != null) // TODO: If shotgun, show countdown
                                Padding(
                        ...
                        child: ClipRRect(
                          ...
                          child: Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                AutoSizeText(
                                  DateFormat('dd').format(meta.date),
                                  textAlign: TextAlign.center,
                                  style: const TextStyle(
                                    color: Colors.black,
                                    fontSize: 22,
                                ...
                                AutoSizeText(
                                  AdvertTextConstants.months[int.parse(
                                        DateFormat('MM').format(meta.date),
                                      ) -
                                      1],
                                  textAlign: TextAlign.center,
                                  style: const TextStyle(
