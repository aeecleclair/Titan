...
class ReservationListNotifier extends StateNotifier<List<Reservation>> {
  ReservationListNotifier([List<Reservation>? listReservation]) : super(listReservation ?? []);
...
final listReservationProvider =
  ...
  return ReservationListNotifier([
    Reservation(date: "12/04/2020 - 18h30-23h", title: "Réservation 1", state: 0),
    Reservation(date: "12/04/2020 - 18h-19h", title: "Réservation 2", state: 0),
    Reservation(date: "12/04/2020 - 19h30-21h", title: "Réservation 3", state: 0),
    Reservation(date: "12/04/2020 - 18h30-23h", title: "Réservation 4", state: 0),
    Reservation(date: "12/04/2020 - 18h-19h", title: "Réservation 5", state: 0),
    Reservation(date: "12/04/2020 - 19h30-21h", title: "Réservation 6", state: 0),
    Reservation(date: "12/04/2020 - 18h30-23h", title: "Réservation 7", state: 0),
    Reservation(date: "12/04/2020 - 18h-19h", title: "Réservation 8", state: 0),
    Reservation(date: "12/04/2020 - 19h30-21h", title: "Réservation 9", state: 0),
    Reservation(date: "12/04/2020 - 18h30-23h", title: "Réservation 10", state: 0),
  ]);
});
