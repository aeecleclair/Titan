...
class ColorConstants {
  ...
  static const Color gradient1 = Color(0xff79a400);
  static const Color gradient2 = Color(0xff387200);
  static const Color textDark = Color(0xff255000);
  static const Color textLight = Color(0xff528700);
  static const Color l1 = Color(0xdfa8c700);
  static const Color l2 = Color(0xdF79a400);
