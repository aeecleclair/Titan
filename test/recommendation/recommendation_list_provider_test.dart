  ...
  group(
    ...
    () {
      ...
      test('Should add a recommendation', () async {
        ...
        await recommendationListProvider.loadRecommendation();
        final recommendation = await recommendationListProvider
      ...
      test('Should update a recommendation', () async {
        ...
        await recommendationListProvider.loadRecommendation();
        final room = await recommendationListProvider
            .updateRecommendation(newRecommendation);
        expect(room, true);
      });

      test(
        'Should delete a recommendation',
        () async {
          final mockRecommendationRepository = MockRecommendationRepository();
          final newRecommendation = Recommendation.empty().copyWith(id: "1");
          when(() => mockRecommendationRepository.getRecommendationList())
          ...
          final room =
              await roomListProvider.deleteRecommendation(newRecommendation);
          expect(room, true);
        },
      );
    },
